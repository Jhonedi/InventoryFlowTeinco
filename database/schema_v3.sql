...
-- 1. Sistema de solicitudes de repuestos por técnicos
-- 2. Flujo de aprobación de salidas por almacenista
-- 3. Módulo de ventas y facturación expandido
-- 4. Sistema de alertas mejorado con estados y recordatorios
-- 5. Audit log completo
-- 6. Super Usuario protegido
-- 7. Mensajes internos entre usuarios
-- 8. Imágenes de repuestos
...
-- Tabla de roles (expandida con Super Usuario)
CREATE TABLE roles (
...
CREATE TABLE vehiculos_clientes (
    ...
    placa VARCHAR(10) NOT NULL UNIQUE COMMENT 'Formato: ABC123 (autos) o ABC12D (motos)',
    modelo_vehiculo_id INT NOT NULL,
    anio INT,
    color VARCHAR(50),
...
CREATE TABLE solicitudes_repuestos (
    ...
    FOREIGN KEY (facturado_por) REFERENCES usuarios(id),
...
CREATE TABLE historial_ajustes_inventario (
    ...
    usuario_id INT NOT NULL COMMENT 'Usuario que solicita el ajuste',
    motivo TEXT,
    estado ENUM('PENDIENTE', 'APROBADO', 'RECHAZADO') DEFAULT 'PENDIENTE',
    aprobado_por INT NULL COMMENT 'Admin/SuperUsuario que aprueba',
    fecha_aprobacion TIMESTAMP NULL,
    motivo_rechazo TEXT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (repuesto_id) REFERENCES repuestos(id),
...
CREATE TABLE alertas_inventario (
    id INT PRIMARY KEY AUTO_INCREMENT,
    repuesto_id INT NULL COMMENT 'NULL para alertas generales del sistema',
    ...
    -- Control de flujo
    atendida_por INT NULL COMMENT 'Usuario que está atendiendo la alerta',
    fecha_atencion TIMESTAMP NULL,
    resuelta_por INT NULL,
    fecha_resolucion TIMESTAMP NULL,
    archivada_por INT NULL,
    ...
    FOREIGN KEY (archivada_por) REFERENCES usuarios(id),
    INDEX idx_estado (estado),
...
-- Insertar roles predeterminados (incluyendo Super Usuario)
...
INSERT INTO usuarios (username, password_hash, nombre_completo, email, rol_id, es_protegido) VALUES
('superusuario', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/X4.xvMqvRfPEOaY1G', 'Super Usuario del Sistema', 'super@taller.com', 1, TRUE);
...
('admin', '$2b$12$Y2AGfKQsLpKfPOHK5ZO/gOYwgznuQbT6gOI3mOQ8EySTMrwm3GP56', 'Administrador del Sistema', 'admin@taller.com', 2);
