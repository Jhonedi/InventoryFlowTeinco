...
-- Ejecutar después de crear la base de datos con schema_v2.sql
...
('almacenista1', '$2b$12$LQv3c1yqBwlVHpPx8fCv5uTeVF8z/TJ.cKo9lYz/h2SqKTK8lBvMu', 'Carlos Mendoza', 'carlos.mendoza@taller.com', 2),
('vendedor1', '$2b$12$LQv3c1yqBwlVHpPx8fCv5uTeVF8z/TJ.cKo9lYz/h2SqKTK8lBvMu', 'María Rodríguez', 'maria.rodriguez@taller.com', 3),
('tecnico1', '$2b$12$LQv3c1yqBwlVHpPx8fCv5uTeVF8z/TJ.cKo9lYz/h2SqKTK8lBvMu', 'Juan Pérez', 'juan.perez@taller.com', 4),
('tecnico2', '$2b$12$LQv3c1yqBwlVHpPx8fCv5uTeVF8z/TJ.cKo9lYz/h2SqKTK8lBvMu', 'Ana García', 'ana.garcia@taller.com', 4);
...
INSERT INTO vehiculos_clientes (cliente_id, placa, modelo_vehiculo_id, anio, color, kilometraje_actual) VALUES
(1, 'ABC123', 1, 2018, 'Rojo', 45000),
(1, 'DEF456', 11, 2020, 'Blanco', 25000),
(2, 'GHI789', 16, 2019, 'Negro', 38000),
(3, 'JKL012', 18, 2021, 'Gris', 50000),
(3, 'MNO345', 18, 2020, 'Blanco', 65000),
(3, 'PQR678', 18, 2019, 'Azul', 80000),
(4, 'STU901', 6, 2017, 'Plata', 55000),
(5, 'VWX234', 26, 2022, 'Rojo', 15000),
(6, 'YZA567', 3, 2016, 'Negro', 90000),
(7, 'BCD890', 21, 2021, 'Blanco', 32000),
(8, 'EFG123', 13, 2020, 'Azul', 28000);

-- Motos
INSERT INTO vehiculos_clientes (cliente_id, placa, modelo_vehiculo_id, anio, color, kilometraje_actual) VALUES
(1, 'HIJ45K', 26, 2021, 'Negro', 12000),
(4, 'LMN67P', 26, 2020, 'Rojo', 18000);
...
(1, 1, 50, 18000, 2, 'CONFIRMADO', 'Compra mensual proveed or principal', '2025-01-10 10:30:00'),
(2, 1, 40, 25000, 2, 'CONFIRMADO', 'Compra mensual proveedor principal', '2025-01-10 10:30:00'),
(5, 1, 60, 45000, 2, 'CONFIRMADO', 'Compra lubricantes', '2025-01-15 14:00:00'),
(9, 1, 30, 60000, 2, 'CONFIRMADO', 'Compra pastillas de freno', '2025-01-20 11:00:00');
...
(1, 4, 5, 3, 4, 1, 'CONFIRMADO', 'Cambio de aceite y filtros', '2025-02-01 09:00:00'),
(2, 4, 5, 3, 4, 1, 'CONFIRMADO', 'Cambio de aceite y filtros', '2025-02-01 09:00:00'),
(5, 4, 2, 3, 4, 1, 'CONFIRMADO', 'Cambio de aceite', '2025-02-01 09:00:00'),
(9, 4, 4, 3, 5, 3, 'CONFIRMADO', 'Cambio pastillas freno', '2025-02-05 10:30:00'),
(17, 4, 4, 3, 4, 2, 'CONFIRMADO', 'Cambio bujías', '2025-02-08 15:00:00');

-- ==================== CREAR ALGUNAS ALERTAS ====================
-- Repuestos con stock bajo
INSERT INTO alertas_inventario (repuesto_id, tipo_alerta, nivel_prioridad, mensaje) VALUES
(16, 'STOCK_BAJO', 'ALTA', 'El repuesto Rótula Suspensión (SUS-004) tiene stock bajo: 8 unidades'),
(23, 'STOCK_BAJO', 'ALTA', 'El repuesto Alternador Reconstruido (ELE-003) tiene stock bajo: 3 unidades'),
(24, 'STOCK_BAJO', 'ALTA', 'El repuesto Motor de Arranque (ELE-004) tiene stock bajo: 4 unidades');

-- ==================== NOTIFICACIONES PARA USUARIOS ====================
INSERT INTO notificaciones_usuarios (usuario_id, alerta_id) VALUES
(1, 1), (1, 2), (1, 3),  -- Admin recibe todas
(2, 1), (2, 2), (2, 3);  -- Almacenista recibe todas
